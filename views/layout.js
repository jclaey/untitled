      ...
      <!DOCTYPE html>
        <html>
          ...
          <body>
            ...
            ${req && req.originalUrl && req.originalUrl.includes('/product') && req.originalUrl.includes('/new') || req.originalUrl.includes('/edit') ? '<script src="/javascript/selectToggler.js"></script>' : ''}
