      ...
      <!DOCTYPE html>
        <html>
          ...
          <body>
            ...
            ${req && req.originalUrl && req.originalUrl.includes('/checkout') ? '<script src="https://js.stripe.com/v3/"></script><br /><script src="/javascript/toggleShipping.js"></script>"<br /><script src="/javascript/checkout.js"></script>' : ''}
